        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-white shadow-sm">
                    <div class="inner">
                        <h3 class="text-{{setting('theme_color','primary')}}">{{$advertsCount}}</h3>
                    ...
                    <a href="{{route('adverts.index')}}" class="small-box-footer">{{trans('lang.dashboard_more_info')}}
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <p class="ml-auto d-flex flex-column text-right">
                                <span class="text-success"> {{$advertsCount}}</span></span>
                                <span class="text-muted">{{trans('lang.dashboard_total_adverts')}}</span>
                            </p>
                        </div>
                        <!-- /.d-flex -->
