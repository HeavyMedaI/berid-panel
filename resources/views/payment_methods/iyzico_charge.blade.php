        ...
        <section class="container-lg">
            <div class="cell example example1" id="example-1">
                <form>
                    ...
                    <button type="submit" data-tid="elements_examples.form.pay_button">Pay {!!  getPrice($advert->getTotal()) !!} </button>
        ...
        form.addEventListener('submit', function (e) {
            ...
            stripe.createPaymentMethod({type: 'card', card: elements[0], 'billing_details': additionalData}).then(function (result) {
                ...
                if (result.paymentMethod) {
                    $.ajax({
                        type: 'GET',
                        url: "{!! url('payments/stripe/pay-success',['booking_id' => $advert->id]) !!}/" + result.paymentMethod.id,
